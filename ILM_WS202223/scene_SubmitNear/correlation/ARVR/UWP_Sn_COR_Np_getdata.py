...
if __name__ == "__main__":
    ...
    for p in probands:
        ...
        sceneSubmitNearButton_1_Right = runAnalyzeFirstButton(p, sceneName, devices)
        sceneSubmitNearCheckbox_1_Right = runAnalyzeFirstCheckbox(p, sceneName, devices)
        sceneSubmitNearButton_2_Right = runAnalyzeSecondButton(p, sceneName, devices)
        sceneSubmitNearCheckbox_2_Right = runAnalyzeSecondCheckbox(p, sceneName, devices)
        sceneSubmitNearButton_3_Right = runAnalyzeThirdButton(p, sceneName, devices)
        sceneSubmitNearCheckbox_3_Right = runAnalyzeThirdCheckbox(p, sceneName, devices)
        ...
        sceneSubmitNearButton_1_Left = runAnalyzeFirstButton(p, sceneName, devices)
        sceneSubmitNearCheckbox_1_Left = runAnalyzeFirstCheckbox(p, sceneName, devices)
        sceneSubmitNearButton_2_Left = runAnalyzeSecondButton(p, sceneName, devices)
        sceneSubmitNearCheckbox_2_Left = runAnalyzeSecondCheckbox(p, sceneName, devices)
        sceneSubmitNearButton_3_Left = runAnalyzeThirdButton(p, sceneName, devices)
        sceneSubmitNearCheckbox_3_Left = runAnalyzeThirdCheckbox(p, sceneName, devices)
        ...
        Sn_Wi_1 = [sceneSubmitNearButton_1_Right, sceneSubmitNearCheckbox_1_Right,
                   sceneSubmitNearButton_1_Left, sceneSubmitNearCheckbox_1_Left]

        Sn_Wi_1 = gf.aggregateData(Sn_Wi_1)

        if Sn_Wi_1 != []:
            print(Sn_Wi_1)
            Sn_Wi_1 = statistics.mean(Sn_Wi_1)
            allSn_1_Wi.append(Sn_Wi_1)

        Sn_Wi_2 = [sceneSubmitNearButton_2_Right, sceneSubmitNearCheckbox_2_Right,
                    sceneSubmitNearButton_3_Right, sceneSubmitNearCheckbox_3_Right,
                    sceneSubmitNearButton_2_Left, sceneSubmitNearCheckbox_2_Left,
                    sceneSubmitNearButton_3_Left, sceneSubmitNearCheckbox_3_Left]

        Sn_Wi_2 = gf.aggregateData(Sn_Wi_2)

        if Sn_Wi_2 != []:
            print(Sn_Wi_2)
            Sn_Wi_2 = statistics.mean(Sn_Wi_2)
            allSn_2_Wi.append(Sn_Wi_2)

    gf.writeToDb('Sn-Wi-1-Np-HL2', allSn_1_Wi)
    gf.writeToDb('Sn-Wi-2-Np-HL2', allSn_2_Wi)
