...
if __name__ == "__main__":
    ...
    probands = gf.probandsFemale

    sceneNameLeft = 'ILM_Submit-Near_Left_Scene'
    sceneNameRight = 'ILM_Submit-Near_Right_Scene'
    scenes = ['ILM_Submit-Near_Left_Scene', 'ILM_Submit-Near_Right_Scene']
    devices = ['MQP', 'MQ2']
    ...
    gf.writeToDb('Sn-Ad-1-Gender-Female_aggr', all_Sn_1)


    Ad_Sn_2 = [secondElementsLeft]
    Ad_Sn_2 = gf.aggregateData(Ad_Sn_2)
    gf.writeToDb('Sn-Ad-2-Gender-Female_aggr', all_Sn_2)
