...
if __name__ == "__main__":
    ...
    probands = gf.probandsQuestProFirst
    ...
    firstElementsRight = gf.aggregateData(firstElementsRight)
    ...
    secondElementsRight = gf.aggregateData(secondElementsRight)


    boxplotElementRightArray = [firstElementsRight, secondElementsRight]
    ...
    gf.writeToDb('Sn-Ad-1-Training-MQP-First', Ad_Sn_1)


    Ad_Sn_2 = [secondElementsLeft, secondElementsRight]
    Ad_Sn_2 = gf.aggregateData(Ad_Sn_2)
    gf.writeToDb('Sn-Ad-2-Training-MQP-First', Ad_Sn_2)
